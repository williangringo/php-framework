...
*/
require_once(dirname(__FILE__) . '/adLDAP/collections/adLDAPCollection.php');
require_once(dirname(__FILE__) . '/adLDAP/classes/adLDAPGroups.php');
require_once(dirname(__FILE__) . '/adLDAP/classes/adLDAPUsers.php');
require_once(dirname(__FILE__) . '/adLDAP/classes/adLDAPFolders.php');
require_once(dirname(__FILE__) . '/adLDAP/classes/adLDAPUtils.php');
require_once(dirname(__FILE__) . '/adLDAP/classes/adLDAPContacts.php');
require_once(dirname(__FILE__) . '/adLDAP/classes/adLDAPExchange.php');
require_once(dirname(__FILE__) . '/adLDAP/classes/adLDAPComputers.php');
